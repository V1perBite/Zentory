...
import { Search, Eye, XCircle, FileText, User, Calendar, Tag, Info } from "lucide-react";
            ...
            <div className="flex gap-2">
              ...
              {isAdmin && f.estado === "anulada" && f.razon_anulacion ? (
                <button
                  ...
                  className="flex h-11 items-center justify-center gap-2 rounded-xl bg-slate-100 px-4 text-sm font-semibold text-slate-600 active:bg-slate-200"
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isAdmin && f.estado === "anulada" && f.razon_anulacion ? (
                      <button
                        type="button"
                        onClick={() => setRazonPanel(f)}
                        className="flex h-8 items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-3 text-xs font-semibold text-slate-600 shadow-sm hover:bg-slate-100 hover:text-slate-800"
                      >
                        <Info className="h-3.5 w-3.5" /> Razón
                      </button>
                    ) : null}
                    {isAdmin && f.estado !== "anulada" ? (
                      <button
          ...
          >
            ...
            <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-amber-800">{razonPanel.razon_anulacion}</p>
              </div>
            </div>
